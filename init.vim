...
" ---- Colorscheme ----
execute 'set runtimepath^=' . fnameescape(fnamemodify(expand('<sfile>:p'), ':h') . '/plugin/colorschemes/gruvbox')
colorscheme gruvbox
...
execute 'source ' . fnameescape(fnamemodify(expand('<sfile>:p'), ':h') . '/plugin/keybindings/keybind.vim')
